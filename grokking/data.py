...
def get_augmented_data_with_agop_loader(operation, prime, n, training_fraction, batch_size, agop_batch_size, drop_last=True):
    inputs1, labels1, inputs2, labels2 = operation_mod_p_data_augmented(operation, prime, n)
...
#     val_labels = torch.cat(val_labels)
#
#     return train_loader, agop_loader, val_loader, val_loader, context_len, train_dataset, val_dataset, train_feats, train_labels, val_feats, val_labels

...
python cli.py --training_fraction 0.5 --prime 31 --batch_size 32 --device cuda --model fcn --eval_entk -1 --num_layers 2 --weight_decay 0.0 --agop_weight 1.0 --wandb_proj_name "nov15-grokking" --agop_subsample_n -1
